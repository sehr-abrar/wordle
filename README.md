...
- [x] Changed the different words that can be generated in the game.
...
The stretch feature of the reset button was a bit difficult to implement, since the positioning and feature wasn't initially working correctly, but after some debugging I managed to overcome this challenge.
